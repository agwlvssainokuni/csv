...
public class CsvParserTest {
	...
	public void testCASE100() {
		...
		try {
			...
			assertNotNull(record);
			assertEquals(2, record.size());
			assertEquals("aa", record.get(0));
			assertEquals("bb", record.get(1));
			// 2nd line
			record = reader.read();
			assertNull(record);
		} catch (IOException ex) {
	...
	public void testCASE103() {
		...
		try {
			...
			assertNotNull(record);
			assertEquals(2, record.size());
			assertEquals("cc", record.get(0));
			assertEquals("dd", record.get(1));
			// 3rd line
			record = reader.read();
			assertNull(record);
		} catch (IOException ex) {
	...
	public void testCASE105() {
		...
		try {
			...
			assertNotNull(record);
			assertEquals(2, record.size());
			assertEquals("a\"a", record.get(0));
			assertEquals("b\"\"b", record.get(1));
			// 2nd line
			record = reader.read();
			assertNull(record);
		} catch (IOException ex) {
	...
	public void testCASE205() {
		...
		try {
			...
			assertNotNull(record);
			assertEquals(2, record.size());
			assertEquals("c\rc", record.get(0));
			assertEquals("d\nd", record.get(1));
			// 3rd line
			record = reader.read();
			assertNull(record);
